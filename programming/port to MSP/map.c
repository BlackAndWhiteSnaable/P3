...
/* Change to map load starts here */
  ...
  const int rows = 11;       // Size of map (newlines)
  const int cols = 11;       // Size of map (characters)

  //Manually set start and finish position
  ...
  strcpy(robot->map.segments[1],  "#A o o o o#");
  strcpy(robot->map.segments[2],  "## ###### #");
  strcpy(robot->map.segments[3],  "#o o o o o#");
  strcpy(robot->map.segments[4],  "######### #");
  strcpy(robot->map.segments[5],  "#o o o o o#");
  strcpy(robot->map.segments[6],  "# ####### #");
  strcpy(robot->map.segments[7],  "#o#o o#o o#");
  strcpy(robot->map.segments[8],  "# ## ###  #");
  strcpy(robot->map.segments[9],  "#o o#o B#o#");
  strcpy(robot->map.segments[10], "###########");
  //-------------------------------END MANUAL-------------------------------//
