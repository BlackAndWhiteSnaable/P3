...
In an attempt to take it a step further \todo{be more specific please - maybe, To check if the map matches the real physical environment...}, we decided to use IR distance sensors. 
