...
the Electronics and Computer Engineering course,
with the purpose of completing the P3 project in the third semester.
From this point on,
every mention of \textbf{we} or \textbf{the group} refers to the three co-authors listed below.

All code written for this project can be found in the appendix and the GitHub repository \cite{GitHub}.
\todo{not all code? Maybe most important parts of the code?}
