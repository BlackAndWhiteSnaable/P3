...
\todo[inline,color=backcolour]{All our code files should be in appendix, call it "Source code" and list all the files}
\todo[inline,color=backcolour]{Do we refer to Queue and Stack functions? It should be in the appendix as code anyways}
\todo[inline,color=backcolour]{Block diagram is missing in appendix, and does it get referred to in the text?}
