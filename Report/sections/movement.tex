...
\begin{figure}[htp] 
    ...
    \subfloat[Increased Pole Pairs]{%
        \includegraphics[width=0.4\textwidth]{figures/motor7.png}%
        }%
    \hfill%
    \subfloat[Increased Number of Winding]{%
        \includegraphics[width=0.4\textwidth]{figures/motor8.png}%
        }%
\end{figure}
...
\begin{figure}[htp] 
    ...
    \subfloat[$1\textsuperscript{st}$ Step]{
        \includegraphics[width=0.2\textwidth]{figures/motor9.png}
        }
    \hfill
    \subfloat[$2\textsuperscript{nd}$ Step]{
        \includegraphics[width=0.2\textwidth]{figures/motor10.png}
        }
    \hfill
    \subfloat[$3\textsuperscript{rd}$ Step]{
    	\includegraphics[width=0.2\textwidth]{figures/motor11.png}
    	}
  	\hfill
  	\subfloat[$4\textsuperscript{th}$ Step]{
  		\includegraphics[width=0.2\textwidth]{figures/motor12.png}
  		}
\end{figure}
...
\begin{figure}[htp] 
    ...
    \subfloat[$1\textsuperscript{st}$ Step Winding]{
        \includegraphics[width=0.2\textwidth]{figures/motor13.png}
        }
    \hfill
    \subfloat[$2\textsuperscript{nd}$ Step Winding]{
        \includegraphics[width=0.2\textwidth]{figures/motor14.png}
        }
    \hfill
    \subfloat[$3\textsuperscript{rd}$ Step Winding]{
    	\includegraphics[width=0.2\textwidth]{figures/motor15.png}
    	}
  	\hfill
  	\subfloat[$4\textsuperscript{th}$ Winding]{
  		\includegraphics[width=0.2\textwidth]{figures/motor16.png}
  		}
\end{figure}
...
\begin{figure}[htp] 
    ...
    \subfloat[Non Magnetized Rotor]{
        \includegraphics[width=0.4\textwidth]{figures/motor17.png}
        }
    \hfill
    \subfloat[Windings]{%
        \includegraphics[width=0.4\textwidth]{figures/motor18.png}
        }
\end{figure}
...
\begin{figure}[htp] 
    \centering
    \subfloat[$1\textsuperscript{st}$ Step]{
        \includegraphics[width=0.2\textwidth]{figures/motor19.png}
        }
    \hfill
    \subfloat[$2\textsuperscript{nd}$ Step]{
        \includegraphics[width=0.2\textwidth]{figures/motor20.png}
        }
    \hfill
    \subfloat[$3\textsuperscript{rd}$ Step]{
    	\includegraphics[width=0.2\textwidth]{figures/motor21.png}
    	}
  	\hfill
  	\subfloat[$4\textsuperscript{th}$ Step]{
  		\includegraphics[width=0.2\textwidth]{figures/motor22.png}
  		}
\end{figure}
...
\begin{figure}[htp] 
    \centering
    \subfloat[$1\textsuperscript{st}$ Step Winding]{
        \includegraphics[width=0.2\textwidth]{figures/motor23.png}
        }
    \hfill
    \subfloat[$2\textsuperscript{nd}$ Step Winding]{
        \includegraphics[width=0.2\textwidth]{figures/motor24.png}
        }
    \hfill
    \subfloat[$3\textsuperscript{rd}$ Step Winding]{
    	\includegraphics[width=0.2\textwidth]{figures/motor25.png}
    	}
  	\hfill
  	\subfloat[$4\textsuperscript{th}$ Winding]{
  		\includegraphics[width=0.2\textwidth]{figures/motor26.png}
  		}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{figures/motor27.png}
...
\begin{figure}[htp] 
    ...
    \subfloat[Interleaved Teeth]{
        \includegraphics[width=0.4\textwidth]{figures/motor28.png}
        }
    \hfill
    \subfloat[Stepper Motor Inside]{%
        \includegraphics[width=0.4\textwidth]{figures/motor29.png}
        }
\end{figure}
...
\begin{figure}[htp] 
    ...
    \subfloat[Front View Stepper Motor]{
        \includegraphics[width=0.4\textwidth]{figures/motor30.png}
        }
    \hfill
    \subfloat[Winding Configuration]{%
        \includegraphics[width=0.4\textwidth]{figures/motor31.png}
        }
\end{figure}
