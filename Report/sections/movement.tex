...
\todo[inline]{make subsection of direction control}
...
\begin{figure}[htp]
	\begin{center}
	\subfloat[Disabled]{
		\includegraphics[width=0.4\textwidth]{figures/move/motor48}
		}
	\hfill
	\subfloat[Enabled]{
		\includegraphics[width=0.4\textwidth]{figures/move/motor49}
		}
...
\begin{minipage}{0.45\textwidth}
	...
	\captionof{figure}{Tri-State Buffer}
\end{minipage}
\hfill
\begin{minipage}{0.45\textwidth}
	\centering
...
\begin{minipage}{0.45\textwidth}
	...
	\captionof{figure}{Inverting Tri-State Buffer}
\end{minipage}
\hfill
\begin{minipage}{0.45\textwidth}
	\centering
