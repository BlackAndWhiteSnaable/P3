...
\todo[inline]{draw arrows on the figure instead?}
...
By applying a voltage across one of the windings, current will start flowing through it. By using the right-hand rule, the direction of the magnetic flux can be determined. This is represented in figure \ref{fig:flux}.
...
\begin{figure}[htp]
    ...
    \subfloat[Increased Pole Pairs]{%
        \includegraphics[width=0.2\textwidth]{figures/move/motor7.png}%
        }%
    \hfill%
    \subfloat[Increased Number of Winding]{%
        \includegraphics[width=0.2\textwidth]{figures/move/motor8.png}%
        }%
	\hfill%
	\hfill%
