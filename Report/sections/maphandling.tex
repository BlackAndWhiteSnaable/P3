...
\begin{figure}[htp]
    ...
    \subfloat[2D grid map]{%
        \includegraphics[width=0.4\textwidth]{figures/map/2d-map.png}%
        \label{sub:2d_map}
        }%  
    \hspace{0.1\textwidth}  
    \subfloat[2D array]{%
...
\begin{figure}[htp]
    \centering
    \subfloat[ASCII]{%
        \includegraphics[width=0.2\textwidth]{figures/map/5x5map_ascii.png}%
    }
    \hspace{0.2\textwidth}
    \subfloat[UTF8]{%
        \includegraphics[width=0.2\textwidth]{figures/map/5x5map_utf8.png}%
    }
    \caption{5x5 map}
    \label{fig:5x5map}
\end{figure}
