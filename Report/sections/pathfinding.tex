...
\end{figure}
%
\todo[inline,color=codepurple]{talk about A* and lead into heuristics}
...
as explained in Section \ref{sec:map_implement}, \todo[color=codepurple]{does Troels describe this in ch:map?}
...
we update \todo[color=codepurple]{overwrite?} the neighbours \emph{cost to reach}
and \emph{parent}.
