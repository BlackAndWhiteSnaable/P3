...
This chapter will explain the basics of different pathfinding approaches,
...
For pathfinding that would mean looking at all possible paths,
...
the pathfinding algorithm can start.
